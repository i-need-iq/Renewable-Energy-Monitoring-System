    ...
    <div id="content" class="p-4 p-md-5 pt-5 bg-secondary">
      ...
      <div class="container">
        <div>
            ...
            <a href="adminpdf.php" target="_blank" id="export" type="button" class="btn btn-success">Export</a>
        </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="card card-body card-form">
                  <form action="adminuserops.php" method="POST">
                    <div class="mt-3">
